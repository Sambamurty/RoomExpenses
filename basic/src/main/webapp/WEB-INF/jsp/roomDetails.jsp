...
<c:if test="${param.success}">
    <div id="popupMessage">Expense added successfully!</div>
    <script>
        // Call the showPopupMessage function from the external script
        showPopupMessage();
	...
	<div class="filters">
		...
		<div class="filter-item">
			...
			<div class="filter-options">
				<form action="/home/getRoomDetails/filter/getByPerson" method="GET">
		...
		<div class="filter-item">
			...
			<div class="filter-options">
				<form action="/home/getRoomDetails/filter/getBetweenDates" method="get">
		...
		<div class="filter-item">
			...
			<div class="filter-options">
				<form action="/home/getRoomDetails/filter/getBetweenPrice" method="get">
	...
	<div class="modal-overlay">
		<div class="modal-content">
			<h2>Add Expenses</h2>
			<form action="/home/getRoomDetails/addExpenses" method="post">
				...
				<c:forEach var="expense" items="${expensesByRoom}">
					<tr>
						<td style="border: 1px solid #ddd; padding: 8px;">
							${namesByIds[expense.personId.toString()]}</td>
						...
						<td style="border: 1px solid #ddd; padding: 8px;">
							...
							<form action="${pageContext.request.contextPath}/home/deleteRecord"
								method="post" style="display: inline;">
								<input type="hidden" name="personName"
									value="${namesByIds[expense.personId.toString()]}" /> <input
									type="hidden" name="date" value="${expense.date}" /> <input
	...
	<div>
		<form action="/home/getRoomDetails/getMonthlyToPay" method="GET">
