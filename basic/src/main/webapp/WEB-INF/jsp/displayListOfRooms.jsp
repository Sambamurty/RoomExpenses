    ...
    <div class="container">
        ...
        <c:forEach var="item" items="${listOfRooms}">
            <div class="card">
                ...
                <!-- Delete Button -->
                <form id="deleteForm-${item.roomName}" action="/home/deleteRoom" method="post" style="display:inline;">
                ...
                <!-- View Details Button -->
                <a href="/home/getRoomDetails?roomName=${item.roomName}" class="view-details">View Details</a>
            </div>
        </c:forEach>
    </div>
</body>
